# modified from https://github.com/ArthurConmy/Automatic-Circuit-Discovery/blob/14c75e9898eda70a8e0997390077af1ec2543258/acdc/docstring/utils.py#L82
...
def docstring_data_generator(tokenizer, num_patching_pairs, docstring_ind_prompt_kwargs=None):
    ...
    for i in range(num_patching_pairs):
        prompt = docstring_induction_prompt_generator(tokenizer, "rest", **docstring_ind_prompt_kwargs)
    ...
    for prompt in raw_prompts:
        ...
        corrupted_prompt = prompt.corrupt_prompt['random_answer']
